...
-- Script para criar a tabela estabelecimento
...
CREATE SEQUENCE IF NOT EXISTS ESTABELECIMENTO_SEQ START WITH 1 INCREMENT BY 1;

INSERT INTO ESTABELECIMENTO (ID, NOME, CNPJ, ENDERECO, TELEFONE, QTD_VAGA_MOTO, QTD_VAGA_CARRO) VALUES
(NEXTVAL('ESTABELECIMENTO_SEQ'), 'Estacionamento Central', '12345678000195', 'Rua Principal, 123, Centro', '(11) 98765-4321', 20, 50),
(NEXTVAL('ESTABELECIMENTO_SEQ'), 'Estacionamento da Esquina','88765432000198', 'Avenida Secundária, 456, Bairro Alto', '(21) 99876-5432', 10, 30);
...
CREATE TABLE VEICULO (
    ...
    ESTABELECIMENTO_FK BIGINT NOT NULL,
...
INSERT INTO VEICULO (ID, MARCA_FK, MODELO_FK, COR_FK, PLACA, TIPO_CARRO_FK, ESTABELECIMENTO_FK) VALUES (NEXTVAL('VEICULO_SEQ'),3,13,1,'NTD-7714', 1, 1);
INSERT INTO VEICULO (ID, MARCA_FK, MODELO_FK, COR_FK, PLACA, TIPO_CARRO_FK, ESTABELECIMENTO_FK) VALUES (NEXTVAL('VEICULO_SEQ'),5,23,5,'RSV-1989', 1, 2);
INSERT INTO VEICULO (ID, MARCA_FK, MODELO_FK, COR_FK, PLACA, TIPO_CARRO_FK, ESTABELECIMENTO_FK) VALUES (NEXTVAL('VEICULO_SEQ'),4,18,2,'HCG-0588', 2, 1);